  ...
  module Analysis
    ...
    class AnalyzerRegistry
      ...
      def self.create_with_defaults
        ...
        registry.register_if_available(:circular_dependencies, "RailsDependencyExplorer::Analysis::Analyzers::CircularDependencyAnalyzer")
        registry.register_if_available(:dependency_depth, "RailsDependencyExplorer::Analysis::Analyzers::DependencyDepthAnalyzer")
        registry.register_if_available(:rails_components, "RailsDependencyExplorer::Analysis::Analyzers::RailsComponentAnalyzer")
