...
module RailsDependencyExplorer
  module Output
    # CSV output strategy for dependency visualization.
    # Formats dependency data into CSV format using the existing CsvFormatAdapter.
    # Part of Phase 4.1 output strategy hierarchy implementation.
    class CsvOutputStrategy < OutputStrategy
      def initialize
        @adapter = CsvFormatAdapter.new
      end

      # Format dependency data into CSV format
