...
require 'test_helper'
require_relative '../../lib/rails_dependency_explorer/analysis/analyzers/rails_component_analyzer'
...
class RailsComponentAnalyzerMigrationTest < Minitest::Test
  ...
  def test_rails_component_analyzer_maintains_existing_api
    analyzer = RailsDependencyExplorer::Analysis::Analyzers::RailsComponentAnalyzer.new(@dependency_data, include_metadata: false)
  ...
  def test_rails_component_analyzer_provides_metadata_when_requested
    ...
    assert_equal "RailsDependencyExplorer::Analysis::Analyzers::RailsComponentAnalyzer", metadata[:analyzer_class]
