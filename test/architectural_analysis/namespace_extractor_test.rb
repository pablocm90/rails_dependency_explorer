...
require_relative "../../lib/rails_dependency_explorer/analysis/architectural_analysis/namespace_extractor"
...
class NamespaceExtractorTest < Minitest::Test
  def test_extract_namespace_from_simple_class
    namespace = RailsDependencyExplorer::Analysis::ArchitecturalAnalysis::NamespaceExtractor.extract_namespace("User")
    assert_equal "", namespace
  end

  def test_extract_namespace_from_single_level_namespace
    namespace = RailsDependencyExplorer::Analysis::ArchitecturalAnalysis::NamespaceExtractor.extract_namespace("Services::UserService")
    assert_equal "Services", namespace
  end

  def test_extract_namespace_from_multi_level_namespace
    namespace = RailsDependencyExplorer::Analysis::ArchitecturalAnalysis::NamespaceExtractor.extract_namespace("App::Models::User")
    assert_equal "App::Models", namespace
  end

  def test_extract_namespace_from_deep_namespace
    namespace = RailsDependencyExplorer::Analysis::ArchitecturalAnalysis::NamespaceExtractor.extract_namespace("App::Services::External::EmailService")
  ...
  def test_extract_namespaces_from_cycle_with_mixed_classes
    ...
    namespaces = RailsDependencyExplorer::Analysis::ArchitecturalAnalysis::NamespaceExtractor.extract_namespaces_from_cycle(cycle)
