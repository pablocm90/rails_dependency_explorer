...
require_relative "../../lib/rails_dependency_explorer/architectural_analysis/cross_namespace_cycle_filter"
...
class CrossNamespaceCycleFilterTest < Minitest::Test
  def test_identifies_cross_namespace_cycle
    ...
    result = RailsDependencyExplorer::ArchitecturalAnalysis::CrossNamespaceCycleFilter.cross_namespace_cycle?(cycle)
    assert result
  end
  ...
  def test_filters_mixed_cycles_collection
    ...
    cross_namespace_cycles = RailsDependencyExplorer::ArchitecturalAnalysis::CrossNamespaceCycleFilter.cross_namespace_cycles_only(cycles)
